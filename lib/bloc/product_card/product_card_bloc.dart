...
class ProductCardBloc extends Bloc<ProductCardEvent, ProductCardState> {
  ...
  ProductCardBloc({this.product, this.productDetail, this.customerRepo, this.wishlistBloc, this.auth})
  ...
  Stream<ProductCardState> mapEventToState(
    ...
    if (event is AddToWishListProductEvent) {
      ...
      await customerRepo.addToWishList(product.productId, product.varientId, authID: uid);
