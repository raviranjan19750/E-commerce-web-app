...
class ProductAvailabilityBloc extends Bloc<ProductAvailabilityEvent, ProductAvailabilityState> {

  final ProductRepository productRepository;

  ProductAvailabilityBloc({this.productRepository}) :assert(productRepository!=null), super(ProductAvailabilityInitial());
  ...
  Stream<ProductAvailabilityState> mapEventToState(
    ...
    if (event is CheckingProductAvailability)
  ...
  Stream<ProductAvailabilityState> checkAvailability (CheckingProductAvailability event) async* {
