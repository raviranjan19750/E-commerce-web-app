...
Stream<ProductDetailState> loadProductDetail(LoadProductDetail event) async* {
  ...
  ProductVariants productVariants = new ProductVariants(
    ...
    variantID: "VariantID",
    isAvailable: true,
    images:  ["https://ii2.pepperfry.com/media/catalog/product/x/l/236x260/xl-[kids]-classic-leatherette-kids-filled-bean-bag-in-brown-colour-by-can-xl-[kids]-classic-leathere-ecw5ij.jpg",
