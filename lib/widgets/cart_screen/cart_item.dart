...
class _CartItemState extends State<CartItem> {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<CartBloc, CartState>(buildWhen: (previous, current) {
      if ((current is CartDetailLoadingSuccessful) ||
          (current is PrdouctCardViewState && widget.cart.key == current.key)) {
        return true;
      }
      return false;
