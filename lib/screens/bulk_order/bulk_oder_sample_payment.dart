...
class BulkOrderSamplePayment extends StatelessWidget {
        ...
        builder: (BuildContext context) {
          return ChangeNotifierProvider(
              ...
              child: Consumer<BulkOrderQuotationProvider>(
                builder: (BuildContext context,
                    BulkOrderQuotationProvider value, Widget child) {
                  if (!init) {
                    Provider.of<BulkOrderQuotationProvider>(context,
                            listen: false)
                        .initPaymentDialog();
                    init = true;
                  }
                            ...
                            if (value.paymentMethods
                              ...
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  ...
                                  color: (value.selectedPaymentMethod ==
                                ...
                                child: InkWell(
                                  onTap: () {
                                    value.onPaymentMethodSelected(value
                                        .paymentMethods
                                        .elementAt(index)
                                        .modes
                                        .first
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      GridView.builder(
                                        shrinkWrap: true,
                                        itemCount: value.paymentMethods
                                            .elementAt(index)
                                            .modes
                                            .length,
                                        gridDelegate:
  ...
  Future<void> getProfileDetails(String authID, BuildContext context) async {
    ...
    Navigator.of(context).push(MaterialPageRoute(
        builder: (context) => QuotationRazorPay(
      ...
      children: [
          ...
          child: Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                  '₹ ${samplePayment.totalPayingAmount}    ',
                  style: TextStyle(
                      color: Palette.secondaryColor,
                      fontSize: 32,
                      fontWeight: FontWeight.bold),
        ...
        Visibility(
          ...
          child: Container(
            ...
            child: RaisedButton(
              padding:
                  EdgeInsets.only(left: 80, right: 80, top: 24, bottom: 24),
              onPressed: () async {
                showProgressDialog(context, "Fetching Data");
                await getProfileDetails(
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: RaisedButton(
                    padding: EdgeInsets.only(
                        left: 80, right: 80, top: 24, bottom: 24),
                    onPressed: () {
                ...
                Container(
                  ...
                  child: InkWell(
                    onTap: () {
                      List<Tracking> temp =
                          new List.from(trackingList.reversed);
                    ...
                    child: Container(
                      ...
                      child: Text(
                        'Track Samples',
                        style: TextStyle(
                            color: Palette.secondaryColor, fontSize: 24),
                      ),
                    ),
                  ),
                ),
