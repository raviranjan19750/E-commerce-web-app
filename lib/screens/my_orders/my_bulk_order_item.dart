...
class MyBulkOrderItem extends StatelessWidget {
  ...
  String deliveryStatusTag(BulkOrder bulkOrder) {
    if (bulkOrder.orderTracking != null && bulkOrder.orderTracking.isEmpty) {
      if (bulkOrder.sampleTracking != null &&
          bulkOrder.sampleTracking.isNotEmpty) {
                ...
                Row(
                  children: [
                    Column(
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.only(left: 32, top: 8, bottom: 4),
                          child: Text(dateStringLabel(bulkOrder),
                              style: TextStyle(color: Colors.grey[500])),
                        ),
                        Container(
                          margin: EdgeInsets.only(left: 32, bottom: 8),
                          child: Text(
                            dateFormatter(bulkOrder),
                    ...
                    Tooltip(
                      ...
                      textStyle: TextStyle(
                          color: Palette.secondaryColor, fontSize: 18),
                      preferBelow: true,
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            margin:
                                EdgeInsets.only(left: 32, top: 8, bottom: 4),
                            child: Text('Ship to :',
                                style: TextStyle(color: Colors.grey[500])),
                          ),
                          Container(
                    ...
                    Visibility(
                      visible: (bulkOrder.sampleTracking != null &&
                              bulkOrder.sampleTracking.isNotEmpty) ||
                          (bulkOrder.orderTracking != null &&
                              bulkOrder.orderTracking.isNotEmpty),
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          Container(
                            margin:
                                EdgeInsets.only(left: 32, top: 8, bottom: 4),
                            child: Text(deliveryStatusTag(bulkOrder),
                                style: TextStyle(color: Colors.grey[500])),
                          ),
                          Container(
                            margin: EdgeInsets.only(left: 32, bottom: 8),
                      ...
                      children: [
                        Container(
                          margin: EdgeInsets.only(
                              left: 32, top: 8, bottom: 4, right: 32),
                          child: Text(
                              '${idStringTag(bulkOrder)} ${idStringValue(bulkOrder)}',
                              style: TextStyle(color: Colors.grey[500])),
                        ),
                        Visibility(
                      ...
                      Row(
                        children: [
                          Expanded(
                              child: Container(
                            child: Text(
                              productTitle(bulkOrder.productType),
                        ...
                        children: [
                          Row(
                            children: [
                              ...
                              Text(
                                sampleRequestedString(
                                    bulkOrder.isSampleRequested),
                                style: TextStyle(
                                    color: (bulkOrder.isSampleRequested)
                                        ? Colors.green
                                        : Colors.redAccent,
