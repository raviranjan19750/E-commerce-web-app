  ...
  Widget build(BuildContext context) {
    return MultiBlocProvider(
      providers: [
        BlocProvider(
            create: (context) =>
                FilterBloc(searchApi: RepositoryProvider.of(context))..add(InitializeDummyFilter())),
        BlocProvider(
            create: (context) =>
                AllProductBloc(searchApi: RepositoryProvider.of(context))..add(InitializeLoadingProduct()))
      ],
      child: AllProductScreenBuilder(),
    );
  }
}
